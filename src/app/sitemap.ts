...
const staticPages = [
  { path: "", lastModified: "2026-08-30", changeFrequency: "weekly" as const, priority: 1.0 },
  { path: "/features", lastModified: "2026-08-13", changeFrequency: "monthly" as const, priority: 0.8 },
  { path: "/calculator", lastModified: "2026-08-27", changeFrequency: "monthly" as const, priority: 0.8 },
