...
const staticPages = [
  { path: "", lastModified: "2026-08-05", changeFrequency: "weekly" as const, priority: 1.0 },
  { path: "/features", lastModified: "2026-07-01", changeFrequency: "monthly" as const, priority: 0.8 },
  { path: "/calculator", lastModified: "2026-08-06", changeFrequency: "monthly" as const, priority: 0.8 },
