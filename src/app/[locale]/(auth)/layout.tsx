...
export default function AuthLayout({
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-ghibli-cream to-ghibli-warm p-4 selection:bg-primary/30 selection:text-primary dark:from-background dark:to-background">
      {/* Navigation bar */}
